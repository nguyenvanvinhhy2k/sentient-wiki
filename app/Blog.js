    ...
    return (
      ...
      <section id="intro" className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        <div className="grid grid-cols-1 md:grid-cols-1">
          <div className="p-6">
            <h1 className="mb-2 text-2xl font-bold">Blog & Research</h1>
            <p className="mb-4 text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
            Stay updated with the latest research, blog posts, and developments in the Sentient ecosystem.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="intro" className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        <div className="grid grid-cols-1 md:grid-cols-1">
          <div className="p-6">
            <h1 className="mb-2 text-2xl font-bold">Research Overview</h1>
            <p className="mb-4 text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
            The Sentient research initiative encompasses cutting-edge work in decentralized artificial intelligence, distributed computing, and blockchain-based consensus mechanisms. Our research team publishes regular updates on technical developments, theoretical breakthroughs, and practical implementations.
            </p>
            <p className="mb-4 text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
            From peer-reviewed papers to technical blog posts, the Sentient research output covers both fundamental AI research and applied engineering solutions for decentralized intelligence networks.
              </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-1">
          <div className="p-6">
            ...
            <section id="intro" className="overflow-hidden rounded-2xl mb-[20px] border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900 p-4">
                    ...
                    <div className="flex flex-wrap gap-2 text-xs">
                    <span className="rounded-full bg-amber-100 px-3 py-1 font-medium text-amber-800 dark:bg-amber-900/40 dark:text-amber-200">Peer-Reviewed
                    </span>
                    <span className="rounded-full bg-blue-100 px-3 py-1 font-medium text-blue-800 dark:bg-blue-900/40 dark:text-blue-200">Conference</span>
                  </div>
                  </section>
                  ...
                  <section id="intro" className="overflow-hidden rounded-2xl mb-[20px] border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900 p-4">
                    ...
                    <div className="flex flex-wrap gap-2 text-xs">
                    <span className="rounded-full bg-amber-100 px-3 py-1 font-medium text-amber-800 dark:bg-amber-900/40 dark:text-amber-200">Journal
                    </span>
                    <span className="rounded-full bg-blue-100 px-3 py-1 font-medium text-blue-800 dark:bg-blue-900/40 dark:text-blue-200">Economics</span>
                  </div>
                  </section>
          </div>
        </div>
      ...
      <section id="intro" className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        <div className="grid grid-cols-1 md:grid-cols-1">
          <div className="p-6">
            <h1 className="mb-4 text-2xl font-bold">Blog Categories</h1>
            <div className="flex justify-between">
            <section id="intro" className="overflow-hidden text-center w-[48%] rounded-2xl mb-[20px] border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900 p-4">
                    <h3>Technical Deep Dives</h3>
                     <p className=" text-sm leading-relaxed text-zinc-600 dark:text-zinc-300  mt-4">
            ...
            <section id="intro" className="overflow-hidden w-[48%] text-center rounded-2xl mb-[20px] border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900 p-4">
                    <h3>Community Spotlights</h3>
                     <p className=" text-sm leading-relaxed text-zinc-600 dark:text-zinc-300  mt-4">
                     Builder and contributor features
                    </p>
            </section>
